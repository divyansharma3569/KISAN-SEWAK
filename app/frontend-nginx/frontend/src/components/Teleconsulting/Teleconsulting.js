  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 p-6 lg:p-12 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto mb-20 mt-10 relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 mb-8 pb-2">
          Expert Teleconsulting
        </h1>
        
        <p className="text-lg md:text-2xl text-slate-400 leading-relaxed max-w-3xl mx-auto">
          We are building a seamless platform to connect you directly with certified agricultural experts. Get real-time advice, live diagnoses, and personalized treatment plans without leaving your farm.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto w-full relative z-10">
         ...
         <div className="bg-slate-900/60 border border-slate-700/50 rounded-3xl p-8 backdrop-blur-md hover:border-emerald-500/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-100 mb-4">Live Video Calls</h3>
            <p className="text-slate-400 leading-relaxed text-lg">Show your crop's symptoms directly to experts via high-quality video streams for accurate, instant analysis.</p>
         </div>
         ...
         <div className="bg-slate-900/60 border border-slate-700/50 rounded-3xl p-8 backdrop-blur-md hover:border-amber-500/50 hover:shadow-[0_0_30px_rgba(245,158,11,0.15)] transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-100 mb-4">Instant Chat Support</h3>
            <p className="text-slate-400 leading-relaxed text-lg">Share images, receive digital prescriptions, and ask follow-up questions through our secure messaging system.</p>
         </div>
         ...
         <div className="bg-slate-900/60 border border-slate-700/50 rounded-3xl p-8 backdrop-blur-md hover:border-cyan-500/50 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] transition-all duration-300 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl font-bold text-slate-100 mb-4">Verified Agronomists</h3>
            <p className="text-slate-400 leading-relaxed text-lg">Every consultant on our platform is a rigorously vetted agricultural professional, ensuring safe and scientific advice.</p>
         </div>
